...
val others : [ `CHR of char | `STR of string ] -> AmfLevel.t -> string
(** Returns the string containing all characters *)

val mem : [ `CHR of char | `STR of string ] -> AmfLevel.t -> bool
