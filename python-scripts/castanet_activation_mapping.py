...
def get_last_conv_model(model):
    ...
    # If we reach this, it means <model> has no Conv2D layer!
...
def compute_cam(index, tape, predictions, last_conv_output):
    """ """
...
def generate(model, row, r):
    ...
    for c, tile in enumerate(row):
        ...
        with tf.GradientTape(watch_accessed_variables=False,
            ...
            cams = [compute_cam(i, tape, predictions, last_conv_output)
